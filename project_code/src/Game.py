...
class Game:
        def __init__(self):
            ...
            self._initialize_game()  # Move this line here
...
if __name__ == "__main__":
    ...
    def _main_game_loop(self):
     while self.continue_playing:
        ...
        # Parse player input and perform corresponding action
        if player_input == "quit":
            self.continue_playing = False
        elif player_input == "race":
            self.run_race(player_driver, player_car, player_pit_crew)
        elif player_input == "upgrade":
            self.upgrade_menu(player_driver, player_car, player_pit_crew)
        else:
