...
class Event:
    ...
    def handle_event(self, race=None):
        if self.name == 'Race start':
            ...
            race.player_driver.stamina -= 2
            print(f"Low speed corner battle occurred. Driver stamina decreased to {race.player_driver.stamina}")
